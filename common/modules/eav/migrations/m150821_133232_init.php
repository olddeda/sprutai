    ...
    public function init()
    {
        ...
        $this->attributeTypes = [
            [
                ...
                'handlerClass' => '\common\modules\eav\widgets\TextInput',
            ],
            [
                'name' => 'option',
                'storeType' => ValueHandler::STORE_TYPE_OPTION,
                'handlerClass' => '\common\modules\eav\widgets\DropDownList',
            ],
            [
                'name' => 'checkbox',
                'storeType' => ValueHandler::STORE_TYPE_MULTIPLE_OPTIONS,
                'handlerClass' => '\common\modules\eav\widgets\CheckBoxList',
            ],
            [
                'name' => 'array',
                'storeType' => ValueHandler::STORE_TYPE_ARRAY,
                'handlerClass' => '\common\modules\eav\widgets\EncodedTextInput',
            ],
            [
                'name' => 'radio',
                'storeType' => ValueHandler::STORE_TYPE_OPTION,
                'handlerClass' => '\common\modules\eav\widgets\RadioList',
            ],
            [
                'name' => 'area',
                'storeType' => ValueHandler::STORE_TYPE_RAW,
                'handlerClass' => '\common\modules\eav\widgets\Textarea',
            ],
        ];
    }
