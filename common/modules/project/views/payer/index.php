...
$this->title = Yii::t('project-payer', 'title');
...
<div class="project-payer-index detail-view">
	...
	<div class="panel panel-default margin-20">
		<div class="panel-body">
            ...
            <?= DynaGrid::widget([
	            ...
	            'options' => ['id' => 'project-payer-index'],
	            'columns' => [
		            ...
		            [
			            ...
			            'filter' => ArrayHelper::map($project->paymentTypes, 'id', 'title'),
			            'filterWidgetOptions' => [
				            'pluginOptions' => [
				                'allowClear' => true,
                                'hideSearch' => true,
					...
					[
						...
						'headerOptions' => ['width' => '160'],
						'type' => 'text',
						'url' => ['editable', 'id' => $project->id],
						'editableOptions' => function ($data) {
							return [
								'title' => Yii::t('project-payer', 'editable_comment'),
		            ...
		            [
						...
						'editableOptions' => function ($data) {
							return [
								'title' => Yii::t('project-payer', 'editable_status'),
		            ...
		            [
			            ...
			            'buttons' => [
				            'update' => function ($url, $model) use ($project) {
					            return Yii::$app->user->can('project.payer.update') ? Html::a('<span class="glyphicon glyphicon-pencil"></span>', [
						            'update',
				            ...
				            'delete' => function ($url, $model) use ($project) {
					            return Yii::$app->user->can('project.payer.delete') ? Html::a('<span class="glyphicon glyphicon-trash"></span>', [
						            'delete',
						            'project_id' => $project->id,
						            'id' => $model->id,
					            ], [
						            ...
						            'data-method' => 'POST',
						            'data-confirm' => Yii::t('project-payer', 'confirm_delete_name', ['title' => $model->title]),
						            'data-pjax' => '1',
						            'data-toggle' => 'tooltip',
					            ]) : '';
				            },
            ...
            <? /*= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'headerOptions' => ['width' => '160'],
                        'format' => 'currency',
	                    'footer' => Yii::t('project-payer', 'footer_total_price', ['sum' => Yii::$app->formatter->asCurrency(Payment::totalSum($dataProvider->models, 'price'))]),
                    ],
    ...
    <div class="margin-20">
        ...
        <?php if (Yii::$app->user->can('project.payer.create')) { ?>
