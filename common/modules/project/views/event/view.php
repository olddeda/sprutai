	...
	<div class="row">
		<div class="col-sx-12 col-sm-12 col-md-12 col-lg-9">
			...
			<div class="form-group margin-top-10 margin-bottom-0">
				<div class="row">
					<div class="col-md-8">
						<?php if (Yii::$app->user->can('project.event.update')) { ?>
							<?= Html::a('<span class="glyphicon glyphicon-pencil"></span> '.Yii::t('base', 'button_update'), ['update', 'project_id' => $project->id, 'id' => $model->id], [
								'class' => 'btn btn-lg btn-primary'
							]) ?>
						<?php } ?>
						<?php if (Yii::$app->user->can('project.event.index')) { ?>
					...
					<div class="col-md-4 align-right">
						<?php if (Yii::$app->user->can('project.event.delete')) { ?>
							<?= Html::a('<span class="glyphicon glyphicon-trash"></span> '.Yii::t('base', 'button_delete'), ['delete', 'project_id' => $project->id, 'id' => $model->id], [
								'class' => 'btn btn-lg btn-danger',
								'data' => [
									'confirm' => Yii::t('project-event', 'confirm_delete'),
									'method' => 'post',
								],
							]) ?>
						<?php } ?>
