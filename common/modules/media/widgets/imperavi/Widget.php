...
class Widget extends BaseWidget
{
	...
	public static function registerTranslations() {
		if (!isset(Yii::$app->i18n->translations['media-imperavi']) && !isset(Yii::$app->i18n->translations['media-imperavi*'])) {
			Yii::$app->i18n->translations['common/widgets/imperavi'] = [
				'class' => 'yii\i18n\PhpMessageSource',
				'basePath' => '@common/modules/media/widgets/imperavi/messages',
				'forceTranslation' => true,
				'fileMap' => [
					'media-imperavi' => 'imperavi.php'
				]
			];
		}
	}
