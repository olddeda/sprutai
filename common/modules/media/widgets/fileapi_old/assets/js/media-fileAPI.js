(function ($) {
    ...
    $.fn.yiiMediaFileAPI = function (method, options) {
        var slice = [].slice;
        ...
        if (methods[method]) {
            ...
            $.error('Method ' + method + ' does not exist on jQuery.yiiMediaFileAPI');
        }
    };


    var _dataAttr = 'data-media',
        ...
        image: {
            onSelect: function ($instance, settings) {
                return function (e, ui) {
                    ...
                    var modalSelector = methods.getModalSelector(selector);
    ...
    var methods = {
        ...
        image: function (options) {
            return this.each(function () {
                ...
                $(document).on('click', modalSelector + ' [data-media="crop.save"]', function() {
                    $this.fileapi('upload');
