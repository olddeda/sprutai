...
<div class="banner-index">
			...
			<?= GridView::widget([
				...
				'columns' => [
					...
					[
						...
						'url' => ['editable'],
						'editableOptions' => [
							'title' => Yii::t('banner', 'editable_title'),
						],
					],
					...
					[
						...
						'url' => ['editable'],
						'editableOptions' => [
							'title' => Yii::t('banner', 'editable_url'),
						],
					],
					...
					[
						...
						'editableOptions' => function ($data) {
							return [
								'title' => Yii::t('banner', 'editable_status'),
					...
					[
						...
						'buttons' => [
							'view' => function ($url, $model) {
								return Yii::$app->user->can('banner.default.view') ? Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url, [
							...
							'update' => function ($url, $model) {
								return Yii::$app->user->can('banner.default.update') ? Html::a('<span class="glyphicon glyphicon-pencil"></span>', $url, [
							...
							'delete' => function ($url, $model) {
								return Yii::$app->user->can('banner.default.delete') ? Html::a('<span class="glyphicon glyphicon-trash"></span>', $url, [
									'title' => Yii::t('base', 'button_delete'),
									'data-method' => 'POST',
									'data-confirm' => Yii::t('banner', 'confirm_delete_name', ['title' => $model->title]),
									'data-pjax' => '1',
									'data-toggle' => 'tooltip',
								]) : '';
							},
	...
	<?php if (Yii::$app->user->can('banner.default.create')) { ?>
