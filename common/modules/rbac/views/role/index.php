...
$this->title = Yii::t('rbac-role', 'title');
...
<div class="role-index">
					...
					[
						...
						'value' => function($data) {
							return Html::a($data['name'], [
								...
								'title' => Yii::t('rbac-role', 'tooltip_name'),
								'data-pjax' => '0',
								'data-toggle' => 'tooltip',
							]);
						},
						...
						'buttons' => [
							...
							'delete' => function ($url, $data) {
								return Html::a('<span class="glyphicon glyphicon-trash"></span>', [
									...
									'data-method' => 'POST',
									'data-confirm' => Yii::t('rbac-role', 'confirm_delete_name', ['title' => $data['name']]),
									'data-pjax' => '1',
									'data-toggle' => 'tooltip',
								]);
							},
	...
	<?php if (Yii::$app->user->can('rbac.role.create')) { ?>
