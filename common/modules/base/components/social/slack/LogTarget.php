...
class LogTarget extends Target {
	...
	/**
	 * @var \common\modules\base\components\social\slack\Client|string
	 */
	public $slack = 'slack';
	...
	public function getAttachments() {
		...
		foreach ($this->messages as $i => $message) {
			...
			if (Yii::$app->has('request') && ($request = Yii::$app->request) instanceof Request && !(Yii::$app instanceof \yii\console\Application)) {
				$attachment['fields'][] = [
					'title' => 'Referrer',
