<?php
namespace common\modules\base\extensions\telegram;
...
/**
 * Class Telegram
 * @package common\modules\base\extensions\telegram
 */
class Telegram extends Component {
	...
	public function sendMessage(array $option) {
		...
		unset($option['text']);
		$jsonResponse = $this->curl_call("https://api.telegram.org/bot".$this->botToken."/sendMessage?chat_id=".$chat_id.'&text='.$text, $option);
	...
	public function sendAudio(array $option) {
		...
		$jsonResponse = $this->curl_call("https://api.telegram.org/bot".$this->botToken."/sendAudio?chat_id=".$chat_id.'&caption='.$caption, $option);
	...
	public function sendDocument(array $option) {
		...
		unset($option['chat_id']);
		unset($option['caption']);
		$jsonResponse = $this->curl_call("https://api.telegram.org/bot".$this->botToken."/sendDocument?chat_id=".$chat_id.'&caption='.$caption, $option);
	...
	public function sendVideo(array $option) {
		...
		unset($option['chat_id']);
		unset($option['caption']);
		$jsonResponse = $this->curl_call("https://api.telegram.org/bot".$this->botToken."/sendVideo?chat_id=".$chat_id.'&caption='.$caption, $option);
	...
	private function curl_call($url, $option = [], $headers = []) {
