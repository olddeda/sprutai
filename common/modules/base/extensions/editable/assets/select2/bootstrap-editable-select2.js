...
(function ($) {
	...
	$.extend(Constructor.prototype, {
		render: function () {
			...
			if (this.options.select2.hasOwnProperty('placeholder') && !this.options.select2.allowClear) {
				//$('<option>').val('').attr('placeholder', this.options.select2.placeholder).attr('selected', 'selected').prependTo(this.$input);
				//this.$input.prepend("<option value='' selected='selected'></option>");
				//$('<option>', {value: '', selected: true }).prependTo(this.$input);​​​​​​​​​​​
			}
