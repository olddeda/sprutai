...
{
    const GENERATOR_NAME = 'sprut.ai';

    /**
     * @var string
     */
    public $controllerNamespace = 'common\modules\base\extensions\yandexturbo';
            ...
            if (is_array($element)) {
                if (isset($element['class'])) {
                    ...
                    $items[] = [
                        ...
                        'content' => str_replace(' ', '', ArrayHelper::getValue($element, 'content')),
    ...
    protected function buildRssXml(array $elements): string {
        ...
        $socialContent = null;
        if ($pageSocial = Page::findBySlug('content-social')) {
        	$socialContent = $pageSocial->text;
		}
