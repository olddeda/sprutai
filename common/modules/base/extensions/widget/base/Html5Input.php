...
class Html5Input extends InputWidget
{
	...
	protected function renderInput() {
		...
		if ($this->noSupport === false) {
			...
			$noSupport = !empty($this->noSupport) ? $this->noSupport : Yii::t('app', 'It is recommended you use an upgraded browser to display the {type} control properly.', ['type' => $this->type]);
