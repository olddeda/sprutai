...
class InputWidget extends \yii\widgets\InputWidget
{
	...
	const LOAD_PROGRESS = '<div class="appmake-plugin-loading">&nbsp;</div>';
	...
	protected function getInput($type, $list = false) {
		if ($this->hasModel()) {
			...
			return $list ? Html::$input($this->model, $this->attribute, $this->data, $this->options) : Html::$input($this->model, $this->attribute, $this->options);
		}
		$input = $type;
		$checked = false;
