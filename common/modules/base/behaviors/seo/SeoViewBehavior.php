<?php
namespace common\modules\base\behaviors\seo;
...
class SeoViewBehavior extends Behavior {
	...
	public function renderMetaTags() {
		...
		if ( ! empty( $this->_meta_description ) ) {
			$view->registerMetaTag( [ 'name'    => 'description',
			                          'content' => Html::encode( $this->normalizeStr( $this->_meta_description ) )
			] );
		}
		if ( ! empty( $this->_meta_keywords ) ) {
			$view->registerMetaTag( [ 'name'    => 'keywords',
			                          'content' => Html::encode( $this->normalizeStr( $this->_meta_keywords ) )
			] );
		}
