...
use common\modules\base\extensions\Slugifier\Slugifier;

class SlugifyBehavior extends SluggableBehavior
{
	/**
	 * @var string
	 */
	...
	protected function validateSlug($slug) {
		$validator = Yii::createObject(array_merge(['class' => UniqueValidator::class], $this->uniqueValidator));
