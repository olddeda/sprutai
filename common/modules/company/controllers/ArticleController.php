...
class ArticleController extends Controller
{
	...
	public function actionIndex() {
		...
		$dataProvider->query->andWhere([Article::tableName().'.company_id' => $this->companyId]);
	...
	protected function findModel($id, $own = false) {
		...
		return Article::findBy($id, true, 'content-article', ['tags'], false, $own, $conditions, ['user_id', 'created_by']);
	}
}