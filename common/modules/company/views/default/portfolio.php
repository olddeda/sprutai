...
$this->title = Yii::t('company-portfolio', 'title');
			...
			<?= GridView::widget([
				...
				'columns' => [
					...
					[
						...
						'value' => function($data) {
							return ($data->company) ? $data->company->title : null;
						},
						'filter' => Select2::widget([
							'model' => $searchModel,
							'attribute' => 'company_id',
							'items' => ArrayHelper::map(Company::find()->all(), 'id', 'title'),
							'clientOptions' => [
								'allowClear' => true,
								'placeholder' => '',
							],
					...
					[
						...
						'attribute' => 'author_fio',
						'value' => function($data) {
							return $data->author->getAuthorName(true);
						},
						'filter' => Select2::widget([
							'model' => $searchModel,
							'attribute' => 'author_id',
