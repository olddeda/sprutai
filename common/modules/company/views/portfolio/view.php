...
$this->title = Yii::t('content-portfolio', 'title_view');
							...
							'attributes' => [
								...
								[
									...
									'value' => ($model->createdBy) ? Html::a($model->createdBy->fio, [
										...
										'title' => Yii::t('content-portfolio', 'tooltip_user'),
										'data-toggle' => 'tooltip',
										'data-pjax' => '0',
									]) : '-',
									'format' => 'raw',
