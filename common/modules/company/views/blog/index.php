...
<div class="company-blog-index detail-view">
					...
					[
						...
						'buttons' => [
							'view' => function ($url, $model) {
								return Yii::$app->user->can('company.blog.view') ? Html::a('<span class="glyphicon glyphicon-eye-open"></span>', [
									'view',
							...
							'update' => function ($url, $model) use ($company) {
								$can = Yii::$app->user->can('company.blog.update');
								if ($can) {
							...
							'delete' => function ($url, $model) {
								return Yii::$app->user->can('company.blog.delete') ? Html::a('<span class="glyphicon glyphicon-trash"></span>', [
									'delete',
									'company_id' => $model->company_id,
									'id' => $model->id,
								], [
	...
	<?php if (Yii::$app->user->can('company.blog.create')) { ?>
		<div class="margin-20">
