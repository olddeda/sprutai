...
$this->title = Yii::t('content-blog', 'title_view');
	...
	<div class="row">
		<div class="col-sx-12 col-sm-12 col-md-12 col-lg-9">
			...
			<div class="form-group margin-top-10 margin-bottom-0">
				<div class="row">
					<div class="col-md-8">
						<?php if (Yii::$app->user->can('content.blog.update')) { ?>
							...
							'attributes' => [
								...
								[
									...
									'value' => ($model->createdBy) ? Html::a($model->createdBy->fio, [
										...
										'title' => Yii::t('content-blog', 'tooltip_user'),
										'data-toggle' => 'tooltip',
										'data-pjax' => '0',
									]) : '-',
									'format' => 'raw',
