...
<div class="company-article-index detail-view">
					...
					[
						...
						'buttons' => [
							'view' => function ($url, $model) {
								return Yii::$app->user->can('company.article.view') ? Html::a('<span class="glyphicon glyphicon-eye-open"></span>', [
									'view',
							...
							'update' => function ($url, $model) use ($company) {
								$can = Yii::$app->user->can('company.article.update');
								if ($can) {
							...
							'delete' => function ($url, $model) {
								return Yii::$app->user->can('company.article.delete') ? Html::a('<span class="glyphicon glyphicon-trash"></span>', [
									'delete',
									'company_id' => $model->company_id,
									'id' => $model->id,
								], [
									...
									'data-method' => 'POST',
									'data-confirm' => Yii::t('content-article', 'confirm_delete_name', ['title' => $model->title]),
									'data-pjax' => '1',
									'data-toggle' => 'tooltip',
								]) : '';
							},
	...
	<?php if (Yii::$app->user->can('company.article.create')) { ?>
	<div class="margin-20">
