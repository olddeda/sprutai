...
/* @var $searchModel \common\modules\content\models\search\NewsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->context->layoutContent = 'content_no_panel';
$this->context->bodyClass = 'content-no-padding content-no-title';

$this->title = Yii::t('content-news', 'title');
...
<div class="company-news-index detail-view">
					...
					[
						...
						'buttons' => [
							'view' => function ($url, $model) {
								return Yii::$app->user->can('company.news.view') ? Html::a('<span class="glyphicon glyphicon-eye-open"></span>', [
									'view',
							...
							'update' => function ($url, $model) use ($company) {
								$can = Yii::$app->user->can('company.news.update');
								if ($can) {
							...
							'delete' => function ($url, $model) {
								return Yii::$app->user->can('company.news.delete') ? Html::a('<span class="glyphicon glyphicon-trash"></span>', [
									'delete',
									'company_id' => $model->company_id,
									'id' => $model->id,
								], [
	...
	<?php if (Yii::$app->user->can('company.news.create')) { ?>
	<div class="margin-20">
