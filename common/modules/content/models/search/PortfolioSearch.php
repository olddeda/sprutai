...
/**
 * PortfolioSearch represents the model behind the search form about `common\modules\content\models\Portfolio`.
 */
class PortfolioSearch extends Portfolio
{
	...
	public function rules() {
		return [
			[['id', 'company_id', 'author_id', 'type', 'is_main', 'status', 'created_by', 'updated_by', 'created_at', 'updated_at'], 'integer'],
			[['title', 'status', 'category_id', 'tags_ids', 'created_at', 'updated_at', 'author_fio', 'company_title', 'date_at'], 'safe'],
		];
	}
