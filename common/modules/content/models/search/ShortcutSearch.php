...
/**
 * ShortcutSearch represents the model behind the search form about `common\modules\content\models\Blog`.
 */
class ShortcutSearch extends Shortcut
{
	...
	public function rules() {
		return [
			...
			[['title', 'status', 'category_id', 'tags_ids', 'created_at', 'updated_at', 'author_fio'], 'safe'],
		];
	}
