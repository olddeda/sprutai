...
/**
 * NewsSearch represents the model behind the search form about `common\modules\content\models\News`.
 */
class NewsSearch extends News
{
	...
	public function rules() {
		return [
			...
			[['title', 'status', 'tags_ids', 'date_at', 'created_at', 'updated_at', 'author_fio', 'company_title'], 'safe'],
		];
	}
