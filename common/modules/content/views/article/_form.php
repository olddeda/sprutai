...
$text = $model->text_new;
$urlHistory = Url::toRoute(['backup', 'id' => $model->id]);

$js =<<<JS
	$('#article-pinned').change(function() {
...
<div class="content-article-form">
	                ...
	                <?php if (Yii::$app->user->hasRole([Role::SUPERADMIN, Role::ADMIN, Role::EDITOR])) { ?>
                        <div class="row margin-top-20">
                            <div class="col-md-12">
                                ...
                                <fieldset>
                                    <legend><?= Yii::t('content-article', 'header_general') ?></legend>
                        ...
                        <div class="row margin-top-30">
                            <div class="col-md-12">
                                <fieldset>
                                    <legend><?= Yii::t('content-article', 'header_other') ?></legend>
                                ...
                                <fieldset>
                                    <legend><?= Yii::t('content-article', 'header_seo') ?></legend>
		                ...
		                <?= $form->field($model, 'text')->widget(ContentBuilder::class, [
			                'pluginOptions' => [
				                ...
				                'buttons' => Yii::$app->user->getIsAdmin() ?
					                ['bold', 'italic', 'strikethrough', 'formatting', 'textsettings', 'color', 'font', 'formatPara', 'align', 'list', 'table', 'image', 'createLink', 'unlink', 'contentLink', 'icon', 'tags', 'removeFormat', 'html'] :
