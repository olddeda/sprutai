...
$this->title = Yii::t('content-shortcut', 'title_view');
							...
							'attributes' => [
								...
								[
									...
									'value' => ($model->createdBy) ? Html::a($model->createdBy->fio, [
										...
										'title' => Yii::t('content-shortcut', 'tooltip_user'),
										'data-toggle' => 'tooltip',
										'data-pjax' => '0',
									]) : '-',
									'format' => 'raw',
