...
/* @var $searchModel common\modules\content\models\search\ShortcutSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('content-shortcut', 'title');

$this->params['breadcrumbs'][] = $this->title;
?>

<div class="content-shortcut-index">
					...
					[
						...
						'buttons' => [
							'view' => function ($url, $model) {
								return Yii::$app->user->can('content.shortcut.view') ? Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url, [
							...
							'update' => function ($url, $model) {
								$can = Yii::$app->user->can('content.shortcut.update');
							...
							'delete' => function ($url, $model) {
								return Yii::$app->user->can('content.shortcut.delete') ? Html::a('<span class="glyphicon glyphicon-trash"></span>', $url, [
									'title' => Yii::t('base', 'button_delete'),
									'data-method' => 'POST',
									'data-confirm' => Yii::t('content-shortcut', 'confirm_delete_name', ['title' => $model->title]),
									'data-pjax' => '1',
									'data-toggle' => 'tooltip',
								]) : '';
							},
	...
	<?php if (Yii::$app->user->can('content.shortcut.create')) { ?>
