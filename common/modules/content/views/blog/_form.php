                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <fieldset>
                                <legend><?= Yii::t('content-blog', 'header_general') ?></legend>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <fieldset>
                                <legend><?= Yii::t('content-blog', 'header_other') ?></legend>
								...
								<?= $form->field($model, 'company_id')->widget(Select2::class, [
									'items' => \yii\helpers\ArrayHelper::merge([0 => '-'], \common\modules\company\models\Company::listData('id', 'title')),
									'clientOptions' => [
										'hideSearch' => false,
									]
								]) ?>
                            ...
                            <fieldset>
                                <legend><?= Yii::t('content-blog', 'header_seo') ?></legend>
                    ...
                    <div class="container container-fluid is-container contentbuilder">
		                ...
		                <?= $form->field($model, 'text')->widget(ContentBuilder::class, [
			                'pluginOptions' => [
				                ...
				                'buttons' => Yii::$app->user->getIsAdmin() ?
					                ['bold', 'italic', 'formatting', 'textsettings', 'color', 'font', 'formatPara', 'align', 'list', 'table', 'image', 'createLink', 'unlink', 'contentLink', 'icon', 'tags', 'removeFormat', 'html'] :
					                ['bold', 'italic', 'formatting', 'align', 'list', 'table', 'createLink', 'unlink', 'icon', 'tags', 'removeFormat'],
				                'content' => urldecode($model->text),
				                ''
			                ],
		                ])->label(false) ?>
                        ...
                        <div class="form-group margin-top-40 align-center">
                            <div class="btn-group btn-group-lg">
				                ...
				                <?php if (Yii::$app->user->hasRole([Role::SUPERADMIN, Role::ADMIN, Role::EDITOR])) { ?>
								<?= Html::button('<span class="glyphicon glyphicon-ok"></span> '.Yii::t('base', 'button_save'), [
									'id' => 'button-content-submit',
									'class' => 'btn btn-primary btn-lg',
									'data-title-original' => Yii::t('base', 'button_save'),
									'data-title-wait' => '<span class="glyphicon glyphicon-time"></span> '.Yii::t('base', 'button_wait'),
								]) ?>
				                <?php } else { ?>
								<?= Html::button('<span class="glyphicon glyphicon-ok"></span> '.Yii::t('base', 'button_publish'), [
									'name' => 'publish',
									'id' => 'button-content-submit',
									'class' => 'btn btn-primary btn-lg',
									'data-title-original' => Yii::t('base', 'button_publish'),
									'data-title-wait' => '<span class="glyphicon glyphicon-time"></span> '.Yii::t('base', 'button_wait'),
								]) ?>
								<?php } ?>
                            </div>
			                <?php if (Yii::$app->user->can('content.blog.index')) { ?>
