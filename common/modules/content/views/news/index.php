					...
					[
						...
						'buttons' => [
							'view' => function ($url, $model) {
								return Yii::$app->user->can('content.news.view') ? Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url, [
							...
							'update' => function ($url, $model) {
								$can = Yii::$app->user->can('content.news.update');
								if ($can) {
							...
							'delete' => function ($url, $model) {
								return Yii::$app->user->can('content.news.delete') ? Html::a('<span class="glyphicon glyphicon-trash"></span>', $url, [
