...
$this->registerJsFile(Yii::$app->request->baseUrl.'/js/demo/demo-flot.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
?>
				...
				<div class="panel panel-default">
					...
					<div data-height="180" data-scrollable="" class="list-group">
						...
						<a href="#" class="list-group-item">
							<div class="media-box">
								<div class="pull-left">
									<img src="<?= Yii::$app->request->baseUrl ?>/images/user/02.jpg" alt="Image" class="media-box-object img-circle thumb32">
								</div>
						...
						<a href="#" class="list-group-item">
							<div class="media-box">
								<div class="pull-left">
									<img src="<?= Yii::$app->request->baseUrl ?>/images/user/03.jpg" alt="Image" class="media-box-object img-circle thumb32">
								</div>
								<div class="media-box-body clearfix">
						...
						<a href="#" class="list-group-item">
							<div class="media-box">
								<div class="pull-left">
									<img src="<?= Yii::$app->request->baseUrl ?>/images/user/09.jpg" alt="Image" class="media-box-object img-circle thumb32">
								</div>
								<div class="media-box-body clearfix">
						...
						<a href="#" class="list-group-item">
							<div class="media-box">
								<div class="pull-left">
									<img src="<?= Yii::$app->request->baseUrl ?>/images/user/12.jpg" alt="Image" class="media-box-object img-circle thumb32">
								</div>
								<div class="media-box-body clearfix">
						...
						<a href="#" class="list-group-item">
							<div class="media-box">
								<div class="pull-left">
									<img src="<?= Yii::$app->request->baseUrl ?>/images/user/10.jpg" alt="Image" class="media-box-object img-circle thumb32">
								</div>
								<div class="media-box-body clearfix">
