...
$typeName = (isset($typeName)) ? $typeName : \common\modules\content\helpers\enum\Type::getLabel($model->type);
...
<div class="<?= $class ?>">
	<div class="panel-body">
		...
		<?php } ?>
		<div class="title inline margin-top-0"><?= Html::a($model->title, ['/article/view', 'id' => $model->id], ['target' => $linkTarget]) ?></div>
		<div class="image">
			<?= Html::a(Html::img($model->image->getImageSrc(1000, 400, Mode::RESIZE)), ['/article/view', 'id' => $model->id], ['_target' => $linkTarget]) ?>
		</div>
		<div class="text">
			<?= Html::encode($model->descr) ?>
		</div>
		<div class="link">
			<?= Html::a('Читать далее...', ['/article/view', 'id' => $model->id], ['_target' => $linkTarget]) ?>
		</div>
	</div>
</div>