...
$this->params['breadcrumbs'][] = ['url' => 'index', 'label' => Yii::t('content-article', 'title')];
...
<div class="content-view">
	...
	<div class="row">
		<div class="col-sx-12 col-sm-12 col-md-8 col-lg-9">
			...
			<?= Html::a('<span class="glyphicon glyphicon-arrow-left"></span> К списку статей', ['index'], [
				...
				<div class="panel-body">
					<?php if ($model->company_id) { ?>
						<?= $this->render('/companies/default/_block', [
							'model' => $model,
							'url' => ['/companies/default/articles', 'id' => $model->company_id],
						]) ?>
					<?php } else { ?>
