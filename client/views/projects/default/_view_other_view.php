...
<div class="content-view-other-view">
	<div class="grid">
		<div class="col width-100 margin-right-10">
			<?= Html::a(Html::img($model->image->getImageSrc(100, 100, Mode::CROP_CENTER), ['class' => 'img-thumbnail img-circle']), ['/projects/view', 'id' => $model->id]) ?>
		...
		<div class="col width-auto">
			<div class="title">
				<h5 class="margin-0 margin-bottom-5"><?= Html::a($model->title, ['/projects/view', 'id' => $model->id]) ?></h5>
			</div>
			<div class="text">
