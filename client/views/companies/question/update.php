...
$this->params['breadcrumbs'][] = Yii::t('company-question', 'title_update');

$this->title = Yii::t('company-question', 'title_update');

?>

<div class="companies-questions-update detail-view">
