...
$this->title = Yii::t('company', 'title_articles_title', ['title' => $model->title]);

$this->params['breadcrumbs'][] = ['label' => Yii::t('company', 'title'), 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->title, 'url' => ['view', 'id' => $model->id]];
$this->params['breadcrumbs'][] = Yii::t('company', 'title_articles');
?>
		...
		<div class="row">
			<div class="col-sx-12 col-sm-12 col-md-8 col-lg-9">
				<?= ListView::widget([
					...
					'emptyText' => Yii::t('company', 'error_empty_article'),
					'layout' => "{items}\n{pager}"
				]); ?>
			</div>
