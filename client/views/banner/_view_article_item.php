...
<div class="content-view-other-view">
	<div class="grid">
		<div class="col width-100 margin-right-10">
			<?= Html::a(Html::img($model->image->getImageSrc(100, 100, Mode::CROP_CENTER), ['class' => 'img-thumbnail img-circle']), ['/article/view', 'id' => $model->id]) ?>

			<div class="votes">
				<div class="vote">
					<?= \common\modules\vote\widgets\Vote::widget([
						'viewFile' => '@client/views/vote/vote_single',
		...
		<div class="col width-auto">
			<div class="title">
				<h5 class="margin-0 margin-bottom-5"><?= Html::a($model->title, ['/article/view', 'id' => $model->id]) ?></h5>
			</div>
			<div class="date">
