...
$headerTitle = (isset($headerTitle)) ? $headerTitle : Yii::t('news', 'popup_payment_title');
$buttonText = (isset($buttonText)) ? $buttonText : Yii::t('news', 'popup_payment_button_open');
...
<?= Html::a(Yii::t('news', 'popup_payment_button_open'), ['user/signin'], [
...
<div>
<?php Modal::begin([
	'header' => Html::tag('h4', $headerTitle, ['class' => 'margin-0 align-left']),
	'toggleButton' => [
		'label' => $buttonText,
		'tag' => 'button',
		'class' => 'btn btn-primary btn-lg',
